...
import LineChartForVectorController from './lineChartForVectorController';
import LineChartForVectorActionsViewProps from '../../../@types/LineChartForVectorActionsViewProps';

const LineChartForVectorActionsView = (props: LineChartForVectorActionsViewProps) => {
  const {
    enableRefresh,
    sliderValue,
    //sliderXAxisValue,
    ...
    chartTime,
    inputTimeModal
  } = props.lineChartForVectorActionsState;
  const {
    handleEditChartMenu,
...
export default LineChartForVectorActionsView;